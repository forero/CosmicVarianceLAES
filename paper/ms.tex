...
We calculate the mean angular correlation function (ACF) for the best
...
\ref{figure:correlation_random} (random).  The error bars in these figure
represent the standard deviation of the ACF over the subfields.


We compare these results with the observed ACF in the SSA22 field reported by Hayashino et al. 2004 .  

\begin{figure*}
\begin{center}
\includegraphics[width=0.46\linewidth,angle=0]{./plots/match_full_correlation_selected_models.pdf}
\hspace{5mm}
\includegraphics[width=0.46\linewidth,angle=0]{./plot/match_large_correlation_selected_models.pdf}\\
\end{center} 
\caption{ mean ACFs over the 7 subfields of the SSA22 field and their correponding standard deviation (error bars)
some selected models in different mass ranges. \label{figure:correlation_match} }
...
\hspace{5mm}
\includegraphics[width=0.46\linewidth,angle=0]{./plot/random_large_correlation_selected_models.pdf}\\
\end{center} 
\caption{ mean ACFs over the 7 subfields of the SSA22 field and their correponding standard deviation (error bars)
some selected models in different mass ranges. \label{figure:correlation_match} }
