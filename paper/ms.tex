...
models out of the original 90000 models. In what follows we discuss
...
We find that the majority ($80\%$) of the best models have a low
ocacupation fraction $f_{\rm occ}\leq 0.4$. This preference goes in
the same direction as the observational constraint on $f_{\rm occ}\sim
0.1-0.2$ derived at $z=2.2$ by \cite{Hayes2010}.

Their estimation was based on blind surveys of the H$\alpha$ and Lyman $\alpha$ line with the
...
Including the information of the halo mass range size allows us 


These 50 models can be classified into two families of the same
size. 

The first, where the range $M_{\rm min}-M_{\rm max}$ is narrow,
