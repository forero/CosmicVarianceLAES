...
=======
>>>>>>> 74018a0531a32bcc999edfeec6975e5338bfbda2
...
%The comparison between the simulated and observed ACFs is also done using
%$\chi^2$ statistic which includes the information on the measurement
%uncertainties and the statistical dispersio from the $15$ mock surveys
%in the simulation
...
%that there are 60 set of parameters of our model, out of the original
...
%All the models with $\log_{10}M_{\rm min}\geq 11.0$ are now
...
%The list for the model parameters is in the
