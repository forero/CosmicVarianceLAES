...
galaxy is thought to be hosted by a larger dark matter structure known
...
reported a total of $2161$  LAEs with an observed equivalent width, in
...
\begin{figure*}
\begin{center}
\includegraphics[width=0.35\linewidth,angle=0]{Fig6_mass.pdf}
\hspace{5mm}
\includegraphics[width=0.35\linewidth,angle=0]{Fig6_f_occ.pdf}
\end{center} 
...
observations.  The minimum mass and maximum mass of these consistent
 models are found to be in the ranges:   $M_{\rm  max}<10^{12}$\hMsun\ 
 and $10^{10.2}\hMsun\leq M_{\rm min}\leq 10^{11.5}\hMsun$. 
...
find in this paper. All our  best models support the notion that the
