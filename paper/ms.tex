...
the angular correlation function. These three conditions narrow down
the space parameter to $10.1\leq M_{\rm min}\leq11.0$ and
$10.2\leq M_{\rm max}\leq12.0$, $0.1\leq_{\rm occ}\leq 0.2 $. 
 We make available the mock data for the best models in a public repository. 
...
ACF reported by \cite{Hayashino2004}.  The error bars represents the dispersion
in each parameter over all the mock surveys for a given model and dispersion due
to the observational error for the measured ACF by \cite{Hayashino2004}. Rigth: 
