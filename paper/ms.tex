...
ACF. Blue circles represent the results from the mocks and the crosses
from observations. In the left panel Figure \ref{fig:correlation_parameters} we see
...
\begin{figure}
\begin{center}
\includegraphics[width=1.0\linewidth,angle=0]{power_law_correlation_meanden.pdf} 
\end{center}
...
green cross to observations by \citet{Ouchi2010} (right). The error
bars in the theoretical data correspond to the quadratic average of
the fitting errors for each mock survey 
