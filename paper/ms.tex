...
model where a dark matter halo with mass in the range $M_{\rm
  min}<M_{\rm h}<M_{\rm max}$ can only host one LAE with a
probability $f_{\rm occ}$. We define three different families of
parameters consistent with observations based on their mass range
