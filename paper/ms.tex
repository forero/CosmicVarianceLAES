...
(ACF). {\bf \cite{Yamada2012} does not report an ACF measurement for the entire field}. Instead
we use the results by \cite{Hayashino2004} who has reported the ACF for the
first and at the same time the densest sub-field of  SSSA22 as we have mention 
before. 
...
%by \cite{Yamada2012}. 
In the case of \cite{Ouchi2008} the number
