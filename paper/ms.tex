...
%typically of less than $<1.0$ dex. While in the second familiy th
...
\subsection{Models in the context of abundance matching}

The abundance matching methods, whereby a stellar mass is associated
to a halo mass in order to reproduce various luminosity functions, can
be used to interpret the results we have obtained so far. 
