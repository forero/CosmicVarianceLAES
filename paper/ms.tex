...
\caption{ \label{fig:laes_dist} Surface density of dark
...
observations. In Figure \ref{fig:laes_dist} we can read that models
...
fields. The color code shows the number of mock surveys consistent
with observations. In both cases there are three regions of parameter
space that can be clearly distinguised.

The first region corresponds to models where the minimum mass is high
$\log_{10}M_{\rm min}> 11.5$. None of this models is compatible with
observations as expected from the results in the previous section. For
these models the number density of LAEs is too low.
