...
sub-field in all the 15 mock surveys corresponding to the SSA22
...
the ACF as well as the standard deviation of the mean modeled ACFs  are
considered to compute the error in the fitted parameters to ensure ourselves
to include poissonian and cosmic-variance errors. 
...
function [citation needed] that satellite galaxies are not a dominant
...
density threshold can yield different masses up to a factor of 2
[citation needed].
